...
## 测试环境版本
wainum=$(ssh brickcrush@210.73.214.67 "ls -d -l /home/brickcrush/version/${today}R* | wc -l")
wainum=$((wainum + 1))
waibuildDirName=${today}R${wainum}_PP
echo $waibuildDirName

ssh brickcrush@210.73.214.67 "mkdir -p /home/brickcrush/version/${waibuildDirName}"
scp pack/$filename brickcrush@210.73.214.67:/home/brickcrush/version/${waibuildDirName}
ssh brickcrush@210.73.214.67 "cd /home/brickcrush/version/${waibuildDirName}/ && tar xzvf *.tar.gz"
ssh brickcrush@210.73.214.67 "rm /home/brickcrush/version/${waibuildDirName}/release/conf -rf"
ssh brickcrush@210.73.214.67 "cp /home/brickcrush/version/config/conf /home/brickcrush/version/${waibuildDirName}/release/ -rvf"
ssh brickcrush@210.73.214.67 "cp /home/brickcrush/version/config/runserver.sh /home/brickcrush/version/${waibuildDirName}/release/ -rvf"
ssh brickcrush@210.73.214.67 "cp /home/brickcrush/version/config/watch.sh /home/brickcrush/version/${waibuildDirName}/release/ -rvf"
