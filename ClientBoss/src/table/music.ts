...
module table {
export var TMusic : table.ITMusicDefine[] = [
...
// Id
export var TMusicById : game.Dictionary<table.ITMusicDefine> = {}
function readTMusicById(){
  for(let rec of TMusic) {
    TMusicById[rec.Id] = rec; 
  }
}
readTMusicById();
}
