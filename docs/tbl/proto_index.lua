...
export var ProtoId : table.IProtoIdDefine[] = [
		...
		{ Id : 52, Name : "msg.GW2C_UpdateGold" 	},
		...
		{ Id : 95, Name : "msg.GW2C_SendWechatInfo" 	},
		{ Id : 96, Name : "msg.C2GW_StartLuckyDraw" 	},
		{ Id : 97, Name : "msg.GW2C_LuckyDrawHit" 	}
	]
