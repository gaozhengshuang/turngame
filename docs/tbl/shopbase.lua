...
module table {
export var TShop : table.ITShopDefine[] = [
...
// Id
export var TShopById : game.Dictionary<table.ITShopDefine> = {}
function readTShopById(){
  for(let rec of TShop) {
    TShopById[rec.Id] = rec; 
  }
}
readTShopById();
}
